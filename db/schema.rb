...
ActiveRecord::Schema.define(version: 20200912191626) do
  ...
  create_table "cookies", force: :cascade do |t|
    ...
    t.bigint "sheet_id"
    t.index ["sheet_id"], name: "index_cookies_on_sheet_id"
  end
  ...
  add_foreign_key "cookies", "sheets"
  add_foreign_key "sheets", "ovens"
end
